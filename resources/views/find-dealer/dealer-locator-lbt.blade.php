        ...
        <div class="col-lg-3">
            ...
            <div class="card" style="font-family: Montserrat,sans-serif; line-height: 1.5;">
                <div class="card-body" style="padding-bottom: 10px; padding-left: 15px; padding-top: 5px;">
                    ...
                    <div style="display: flex;">
                        <img src="/assets/images/ja-logo.png" style="display: {{ $JA_display }}; border-radius: 4px; margin-right: 10px; width: 50%; max-width: 150px; max-height: 60px;" title="Jonathan Adler">
                        <img src="/assets/images/tb-logo.png" style="display: {{ $TB_display }}; border: 1px solid #122A4F; border-radius: 4px; width: 50%; max-width: 150px; max-height: 60px;" title="Tommy Bahama">
                    </div>
                </div>
            </div>
...
<div class="find-a-dealer-banner" style="height: calc(100vh - 0px);">
