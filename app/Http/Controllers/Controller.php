    ...
    */
    public function dealerLocatorLBT()
    {
        ...
        if (is_null($latlon) || strlen($zip) < 5) {
            ...
            $field_list = 'id, customer_name, address1, address2, city, state, zip, phone1, website, appointment, locator_priority, ifnull(' . $distance_calc . ',1) as distance, ifnull(' . $distance_calc . ',10) * locator_priority as distance_priority, authorized';
